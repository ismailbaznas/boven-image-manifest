...
- **Terakhir Disinkronkan:** 2026-09-11T14:32:03.053Z
- **Total Media Foto:** **1097 media**
- **Total Organisasi:** **6 folder**
- **Total Program Kegiatan:** **20 program**
...
- data/media.json: Seluruh rekaman media, ID (oven-digoel-[N]), URL foto asli (s0), SHA-256 hash, dan metadata.
